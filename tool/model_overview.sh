...
# prototxt=${PROJECT_ROOT}/data/proto_file/deploy/vgg16_4.0x_3ddecomp_deploy.prototxt
...
# prototxt=${PROJECT_ROOT}/data/proto_file/deploy/vgg16_4.0x_2ddecomp_deploy.prototxt
...
prototxt=${PROJECT_ROOT}/data/proto_file/deploy/vgg16_3.0x_spatial-decomp_deploy.prototxt
